...
Controls a Viessmann heating system through the Home Assistant ViCare integration. Away conditions select `standby`, summer conditions select domestic-hot-water-only mode `dhw`, and normal operation uses `dhwAndHeating`.
